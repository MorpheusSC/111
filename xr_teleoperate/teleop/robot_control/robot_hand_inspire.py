...
class Inspire_Controller_DFX:
    def __init__(self, left_hand_array, right_hand_array, dual_hand_data_lock = None, dual_hand_state_array = None,
        ...
        while True:
            ...
            if wait_count > 500:
                logger_mp.warning("[Inspire_Controller_DFX] Timeout waiting for hand states. Proceeding with open-hand defaults.")
                break
        logger_mp.info("[Inspire_Controller_DFX] Subscribe dds ok or timeout.")
